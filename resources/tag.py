...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        tag = Tag.Model.query.get_or_404(tag_id)
...
class Tag(MethodView):
    ...
    @blp.alt_response(400, description="Return if the tag is assigned to one or more items. In this case, tag is not deleted")
    def delete(self, tag_id):
        ...
        abort(400, message="Tag not deleted, make sure the tag is not associated with any items")